    ...
    <footer class="body-font text-color-text dark:text-color-text-dark">
        ...
        <div class="px-size-mobile md:px-size-tablet lg:px-size-desk pb-5 md:py-8 flex items-center sm:flex-row flex-col">
            ...
            <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                <!-- Facebook -->
                <a class="text-gray-500 dark:text-white cursor-pointer" href="#">
                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">      <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                    </svg>
                </a>

                <!-- Twitter -->
                <a class="ml-3 text-gray-500 dark:text-white" href="#">
                ...
                <!-- Instagram -->
                <a class="ml-3 text-gray-500 dark:text-white cursor-pointer" href="#">
