<template>
    <section id="cita"
        class="dark:text-color-text-dark text-color-text px-size-mobile md:px-size-tablet lg:px-size-desk py-20">
        ...
        <form @submit.prevent="submitForm" class="text-center mt-5">
            ...
            <!-- barra de progreso -->
            <ul id="progressbar" class="mb-5 overflow-hidden text-gray-500">
                <li
                    class="active text-color-btn list-none text-lg w-3/12 float-left font-semibold before:font-[FontAwesome] before:content-['\f6d3']">
                    Mascota
                </li>
                <li
                    class="list-none text-lg w-3/12 float-left font-semibold before:font-[FontAwesome] before:content-['\f007']">
                    Dueño
                </li>
                <li
                    class="list-none text-lg w-3/12 float-left font-semibold before:font-[FontAwesome] before:content-['\f481']">
                    Motivo
                </li>
                <li
                    class="list-none text-lg w-3/12 float-left font-semibold before:font-[FontAwesome] before:content-['\f00c']">
                    Confirmación
                </li>
            </ul>
                ...
                <div>
                    ...
                    <div class="flex gap-8 flex-wrap w-full text-start">
                        ...
                        <div class="flex flex-col flex-grow-[1] basis-11/12 md:basis-0">
                            <label for="mascota" class="text-sm font-medium text-gray-700 dark:text-white">Nombre de la
                                mascota</label>
                            ...
                            <label for="especie"
                                class="text-sm font-medium text-gray-700 dark:text-white">Especie</label>
                            <select id="especie" name="especie" v-model="form.especie"
                                class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm focus:border-[#3E9392] focus:ring-1 focus:ring-[#3E9392]"
                                required>
                        ...
                        <div class="flex flex-col flex-grow-[1] basis-11/12 md:basis-0">
                            ...
                            <input type="text" id="raza" name="raza" v-model="form.raza"
                                class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm focus:border-[#3E9392] focus:ring-1 focus:ring-[#3E9392]" />
                            <label for="sexo" class="text-sm font-medium text-gray-700 dark:text-white">Sexo</label>
                            <select id="sexo" name="sexo" v-model="form.sexo"
                                class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm focus:border-[#3E9392] focus:ring-1 focus:ring-[#3E9392]"
                                required>
                                <option value="">Seleccione una opción</option>
                        ...
                        <div class="flex flex-col flex-grow-[1] basis-11/12 md:basis-0">
                            <label for="fecha_nacimiento"
                                class="text-sm font-medium text-gray-700 dark:text-white">Fecha de nacimiento</label>
                            <input type="date" id="fecha_nacimiento" name="fecha_nacimiento"
                                v-model="form.fecha_nacimiento"
                                class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm focus:border-[#3E9392] focus:ring-1 focus:ring-[#3E9392]" />

                            <label for="peso" class="text-sm font-medium text-gray-700 dark:text-white">Peso</label>
                            <input type="number" id="peso" name="peso" v-model="form.peso"
                                class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm focus:border-[#3E9392] focus:ring-1 focus:ring-[#3E9392]" />
                        </div>
                    </div>
                    <!-- Fin de entrada -->
            ...
            <fieldset class="shadow dark:bg-color-box-dark bg-color-box rounded-lg px-6 pb-6">
                <div>
                    <!-- Encabezado -->
                    ...
                    <div class="flex gap-8 flex-wrap w-full text-start">
                        ...
                        <div class="flex flex-col flex-grow-[1] basis-11/12 md:basis-0">
                            <label for="nombre_propietario"
                                class="text-sm font-medium text-gray-700 dark:text-white">Nombre completo</label>
                            <input type="text" id="nombre_propietario" v-model="form.nombre" name="nombre_propietario"
                            ...
                            <label for="celular" class="text-sm font-medium text-gray-700 dark:text-white">Número de
                                Celular</label>
                            <input type="tel" id="celular" name="celular" v-model="form.celular"
                                class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm focus:border-color-btn focus:ring-1 focus:ring-color-btn"
                                required />
                        </div>
                        ...
                        <div class="flex flex-col flex-grow-[1] basis-11/12 md:basis-0">
                            <label for="telefono" class="text-sm font-medium text-gray-700 dark:text-white">Número de
                                teléfono</label>
                            <input type="tel" id="telefono" name="telefono" v-model="form.telefono"
                                class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm focus:border-color-btn focus:ring-1 focus:ring-color-btn" />

                            <label for="direccion"
                                class="text-sm font-medium text-gray-700 dark:text-white">Dirección</label>
                            <input type="text" id="direccion" v-model="form.direccion" name="direccion"
                                class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm focus:border-color-btn focus:ring-1 focus:ring-color-btn"
                                required />
                        </div>
                    </div>
            ...
            <fieldset class="shadow dark:bg-color-box-dark bg-color-box rounded-lg px-6 pb-6">
                <div>
                    ...
                    <div class="flex gap-8 flex-wrap w-full text-start">
                        ...
                        <div class="flex flex-col flex-grow-[1] basis-11/12 md:basis-0">
                            <label for="services"
                                class="text-sm font-medium text-gray-700 dark:text-white">Servicio</label>
                            <select id="services" name="services" v-model="form.servicio"
                                class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm focus:border-color-btn focus:ring-1 focus:ring-color-btn"
                                required>
                                <option value="">Seleccione una opción</option>
                            ...
                            <label for="transporte"
                                class="text-sm font-medium text-gray-700 dark:text-white">Transporte</label>
                            <select name="transporte" id="transporte" v-model="form.transporte"
                                class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm focus:border-color-btn focus:ring-1 focus:ring-color-btn"
                                required>
                                <option value="">Seleccione una opción</option>
                        ...
                        <!-- Fecha y Hora -->
                        <div class="flex flex-col flex-grow-[1] basis-11/12 md:basis-0">
                            <label for="fecha_cita" class="text-sm font-medium text-gray-700 dark:text-white">¿En qué
                                fecha le gustaría agendar la
                                cita?</label>
                            <input type="date" id="fecha_cita" name="fecha_cita" v-model="form.fecha"
                                class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm focus:border-color-btn focus:ring-1 focus:ring-color-btn"
                                required />

                            <label for="hora_cita" class="text-sm font-medium text-gray-700 dark:text-white">¿En qué
                                horario le gustaría agendar la
                                cita?</label>
                            <input type="time" name="hora_cita" id="hora_cita" v-model="form.hora"
                                class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm focus:border-color-btn focus:ring-1 focus:ring-color-btn"
                                required />
                        </div>
                        ...
                        <div class="flex flex-col flex-grow-[1] basis-11/12 md:basis-0">
                            ...
                            <textarea name="comentario" id="comentario" v-model="form.comentario"
                                class="w-full bg-white rounded border border-gray-300 focus:border-color-btn focus:ring-1 focus:ring-color-btn h-[105px] text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid place-items-center">
                        ...
                        <div class="py-5">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="icon icon-tabler icon-tabler-circle-check-filled" width="44" height="44"
        ...
        <ModalAlert :visible="showModal" :title="modalTitle" :message="modalMessage" :type="modalType"
